...
.then((data) =>{
  console.log(data.section);
    ...
    document.querySelector(".4sa-method").innerHTML = data.section[4].h2;
    console.log(data.section[4].h5);
    document.querySelector(".4sa-descp").innerHTML = data.section[4].h5;
